          ...
          <div className=" lg:w-1/3   flex flex-col space-y-4">
            ...
            <div className="bg-pink-100 px-5 flex flex-col space-y-4 py-6">
              ...
              <div className="relative w-full text-left">
                ...
                <button
                  className="px-4 py-3 w-full rounded-md text-black flex items-center justify-between bg-white"
              ...
              <input type="address" placeholder="Zip Code" className="py-3 px-2 border-none rounded-lg outline-none" />
...
{cartItems.length > 0 && (
  cartItems.map((item, index) => (
    <div key={index} className="flex justify-between ">
      <span className="text-lg font-semibold w-80  text-[#787878]">{item.title}</span> 
      <span className="text-gray-500">x {item.quantity}</span> {/* Quantity */}
    </div>
  ))
)}
 <div className="flex justify-between">
      <span className='font-semibold'>Discount (10% off):</span>
      <span className=' text-[#787878]'>- ₹1,199/-</span>
    </div>
    <div className="flex justify-between">
      <span className='font-semibold'>Total:</span>
      <span className=' text-[#787878]'> {totalPrice}₹/-</span> 
    </div>

    <div className="flex justify-between">
      <span className='font-semibold'>Delivery:</span>
      <span className=' text-[#787878]'>₹999/-</span>
    </div>
    ...
    <div className="flex justify-between">
      ...
      <span className=' text-[#787878]'>₹600/-</span>
    </div>

    <div className="flex justify-between font-semibold">
      <span className='font-semibold'> Subtotal:</span>
      <span className=' text-[#787878]'>₹12,399/-</span>
    </div>
      ...
      <span>March 25, 2025</span>
              ...
              <div className=" flex flex-col space-y-3 py-3">
                ...
                <button
                  type="button"
                  onClick={handleClick}
                  className={`w-full text-white text-sm font-medium flex items-center justify-center rounded-full px-2 py-3 transition-all ${isChecked ? "bg-black cursor-pointer" : "bg-gray-400 cursor-not-allowed"
                    }`}
                  disabled={!isChecked}
                >
                  Proceed to checkout
