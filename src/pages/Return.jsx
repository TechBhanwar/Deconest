    ...
    <div>
      ...
      <div className='flex flex-col py-8 mb-10 mt-5 rounded-lg container'>
        <div className='space-y-3 py-4'>
          <h1 className='text-2xl lg:text-4xl font-semibold text-slate-800'>Return Request</h1>
          <h1 className='text-base lg:text-xl font-semibold text-slate-600'>
        ...
        <div className='flex gap-5 flex-col lg:flex-row'>
          <div className='lg:w-2/3 px-3 lg:px-5 py-5 space-y-5 flex flex-col border'>
            ...
            <div className='flex flex-row justify-between'>
              <h1 className='lg:text-lg text-base font-medium text-black'>1 item selected</h1>
              <h1 className='lg:text-lg text-base font-medium text-blue-500'>Select all</h1>
            </div>

            <div className='flex space-x-3 lg:space-x-5 flex-row'>
      ...
      <label for="morning-1" className="flex items-center rounded-md cursor-pointer transition-all border border-gray-300 shadow-sm peer-checked:bg-green-500">
        <div className="lg:w-5 w-4 h-4 lg:h-5 flex items-center justify-center rounded-md peer-checked:bg-green-500 transition-all">
          <svg className="w-3.5 h-3.5 text-white transition-all " viewBox="0 0 12 10" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="1.5 6 4.5 9 10.5 1"></polyline>
              ...
              <div className='bg-pink-100 lg:px-3  py-1 rounded-md lg:h-20 h-16 w-20  '>
                <img src="images/productItems14.webp" alt="" className='w-full h-full' />
              </div>

              <div className='flex space-y-2 flex-col'>
                <h1 className='text-sm lg:text-lg text-gray-800 font-normal lg:font-medium'>
                  Sophisticated White and Gold Lamp for Luxury Interiors
                </h1>
                <h1 className='text-sm lg:text-base text-gray-600 font-normal'>White and Golden Lamp</h1>
              </div>

              <h1 className='text-base lg:text-lg font-medium text-end'>2999 ₹/-</h1>
            </div>
            ...
            <div className='flex space-x-3 lg:space-x-5 flex-row'>
              ...
              <h1 className='text-base lg:text-lg font-medium right-0'>2999 ₹/-</h1>
            </div>
          ...
          <div className='lg:w-1/3 flex space-y-5 flex-col'>
            <div className='flex flex-col px-5 py-4 shadow-md'>
              <div className='justify-between flex py-3 border-b flex-row'>
                <h1 className='lg:text-lg text-base text-black font-medium'>Returning</h1>
                <h1 className='lg:text-lg text-base text-black font-medium'>1 item</h1>
              </div>
              <div className='flex py-3'>
                <h1 className='lg:text-lg text-base text-black font-medium'>
            ...
            <button className="bg-black text-white px-7 h-12 lg:h-14 py-3 lg:w-full text-base lg:text-lg font-semibold rounded-lg">
              Request Return
            </button>

            <button className="border border-black px-7 h-12 lg:h-14 py-3 lg:w-full text-base lg:text-lg font-semibold rounded-lg">
              Cancel
            </button>
          </div>
        </div>
