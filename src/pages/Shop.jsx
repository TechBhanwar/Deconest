...
const Shop = () => {
   ...
   // State to manage the visibility of the review box
   const [showReviewBox, setShowReviewBox] = useState(false);

   // Function to toggle the review box visibility
      ...
      <div className='container py-9 overflow-x-hidden'>
        ...
        <div className='flex flex-row py-3 '>
          <ul className='text-black text-base flex space-x-3 cursor-pointer'>
            ...
            <li>Bathroom<span className='text-gray-400 px-1'>/</span></li>
            <li>Bouquet Flower Vase</li>
          </ul>
        </div>
        ...
        <div className='flex lg:flex-row space-x-0 mb-10 space-y-3 lg:space-y-0 lg:space-x-20 flex-col'>
          <div className='flex flex-col space-y-7'>
            ...
            <div className='flex lg:flex-row flex-col  lg:space-y-3 space-y-0 space-x-0 lg:space-x-7 '>
              ...
              <div className='bg-pink-100 lg:order-2 order-1 relative rounded-lg lg:w-[720px] w-full py-10 h-96 lg:h-[900px] flex justify-center items-center overflow-hidden'>
                <img src={images[currentImage]} alt="Product" className='w-auto h-96 lg:h-fit  object-contain' />
                <span className='bg-red-600 absolute top-3 px-2 py-1 rounded-full text-white text-sm font-medium right-3'>-30%</span>
          ...
          <div className='flex flex-col px-3 lg:px-0  w-full lg:w-[550px] '>
            ...
            <div className='flex flex-col space-y-3 py-1  border-b items-start justify-start ' >
              <h1 className='text-black lg:text-3xl text-xl font-semibold'>Bouquet Flower Vase</h1>
              ...
              <span className='flex flex-row space-x-3'>
                <h1 className='text-black lg:text-xl text-lg font-semibold line-through'>$100.00</h1>
                <h1 className='text-black lg:text-xl text-lg font-semibold '>$70.00</h1>
              </span>
            </div>
            ...
            <div className='flex flex-col space-y-3 py-5'>
              ...
              <div className='flex flex-row   space-x-2'>
                <div className='px-3 py-3  relative group  cursor-pointer rounded-full bg-pink-200 hover:border   hover:border-black'>
                ...
                <div className='px-3 py-3  cursor-pointer relative group rounded-full bg-blue-800 hover:border   hover:border-black'>
                ...
                <div className='px-3 py-3 cursor-pointer  relative group rounded-full bg-green-200 hover:border   hover:border-black'>
                ...
                <div className='px-3 py-3 cursor-pointer relative group rounded-full bg-blue-400 hover:border   hover:border-black'>
              ...
              <div className='flex flex-row space-x-3 lg:space-x-3 py-3'>
                ...
                <button className='bg-black py-1 lg:py-2 px-16 lg:h-14 h-10 lg:px-28 cursor-pointer text-white text-sm lg:text-base rounded-full font-semibold '>Add To Cart</button>
              ...
              <div className='flex flex-row border py-1 lg:py-2 rounded-xl'>
                ...
                <div className='flex flex-col'>
                  <p className='text-gray-400 text-xs lg:text-base flex-row'>Pickup available a <span className='text-black'>Akaze store</span></p>
           ...
           <div className='flex flex-col py-10 px-6 rounded-lg  relative border'>
            ...
            <div className='flex lg:flex-row flex-col  space-y-5  '>
              ...
              <div className='flex flex-row lg:w-2/3 lg:justify-start justify-between  '>
                <div className='flex bg-pink-50 justify-center lg:w-40 w-[900px]   lg:h-44 items-center'>
                  <img src="/images/product1.png" alt="" className='lg:w-28 w-full ' />
                </div>

                <span className='flex justify-center  items-center px-2'>
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className=''  height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z"></path></svg>
                </span>

                <div className='flex bg-pink-50 justify-center lg:w-40 w-[900px]   px-2 lg:h-44 items-center'>
                  <img src="/images/product5.png" alt="" className='lg:w-28 w-full' />
                </div>
                ...
                <div className='flex bg-pink-50 justify-center lg:w-40  w-[900px]  px-2 lg:h-44 items-center'>
                  <img src="/images/product2.png" alt="" className=' lg:w-28 w-full ' />
                </div>

              </div>

               <div className='flex flex-col lg:w-1/3   '>
                   <span className='flex flex-row text-black text-base lg:text-lg '>Toptal Price: <h1 className='text-black px-2 mt-0 text-xl font-medium'>$215.00</h1>

                   </span>
                   <p className='lg:text-base text-sm mb-5 text-gray-400'>For 3 item(s)</p>
                   <button className='cursor-pointer lg:text-base text-sm  text-white font-semibold bg-black rounded-full lg:w-52 w-56 px-0 lg:px-4 py-3'>Add Selected Item(s)</button>
               </div>
            ...
            <div className='flex flex-row space-x-1'>
              <input type="checkbox" />
              <span className='lg:text-sm text-xs mt-0 lg:mt-1'>THIS PRODUCT: BOUQUET FLOWER VASE</span>
              <select name="" id="" className='border lg:text-base text-xs  outline-none'>
                <option value="Beige">Beige</option>
                <option value="Pink ">Pink</option>
                <option value="Blue ">Blue</option>
                <option value="White">White</option>
              </select>
              <h1 className='lg:text-base text-sm'>$75.00</h1>
            </div>
            <div className='flex flex-row space-x-1'>
              <input type="checkbox" />
              <span className='lg:text-sm text-xs mt-1 lg:mt-1'>Century Starburst Clock</span>
              
              <h1>$70.00</h1>
            </div>
            <div className='flex flex-row space-x-1'>
              <input type="checkbox" />
              <span className='lg:text-sm text-xs mt-1 lg:mt-1'>CH07 Shell Chair – Leather </span>
      ...
      <div className='flex flex-row space-x-4 lg:space-x-8 justify-center items-center'>
        {tabs.map((tab) => (
          <button
            ...
            className={`text-base lg:text-lg font-semibold transition-all duration-300 px-3 py-2 rounded-full ${
