...
>
  ...
  { number: "399K+", label: "Happy Customers" }, 
    ...
    <button className="bg-white border-black transition-all duration-300 border hover:bg-black hover:text-white lg:px-8 lg:h-14 py-3 w-48 lg:w-64 text-black text-lg font-semibold rounded-lg shadow-md hover:shadow-lg">
        Get In Touch
    </button>
</div>
